export const UploadIcon = ({ width = '3.2rem', height = '3.2rem', className }: any) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const MessageIcon = ({ width = '2.6rem', height = '2.6rem', className }: any) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const InboxIcon = ({ width = '3.2rem', height = '3.2rem', className }: any) => (
    <svg
        className={className}
        width={width}
        height={height}
