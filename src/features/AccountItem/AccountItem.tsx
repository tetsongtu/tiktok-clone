...
const wrapper = `w-[250px] flex items-center cursor-pointer hover:bg-[var(--primary)] p-1 px-2 group`;
    ...
    return (
        <Link to={`/@${user.nickname}`} className={wrapper}>
            ...
            <section className="truncate ml-3 flex-1">
                <h4 className="text-lg font-semibold flex items-center text-gray-900 group-hover:text-white">
